...
export class Terminal {
    ...
    read_line(line) {
        ...
        wasm.terminal_read_line(this.__wbg_ptr, ptr0, len0);
    }
}
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_clear_f428aa7c13ab7910 = function() {
        clear();
    };
    imports.wbg.__wbg_displayOutput_2fd2188bb97f42f9 = function(arg0, arg1) {
        displayOutput(getStringFromWasm0(arg0, arg1));
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_terminal_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
